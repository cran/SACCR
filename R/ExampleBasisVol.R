...
tr3 = Trading::IRDSwapVol(external_id = "ext_3",Notional=5000,MtM=50,Currency="EUR",Si=1,Ei=11,BuySell='Sell', reference  = "CDOR", vol_strike=0.2, annualization_factor=252)
